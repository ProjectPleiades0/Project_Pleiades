from pleiadesai_core.plugins.utilities.mock import BaseMockUtility, LLMMockUtility
...
class CoinTechnicalAnalyzerMockUtility(LLMMockUtility):
    coin_analysis = {
        "sol": {
            ...
            "url": "https://data.pleiades.ai/tool_responses/coin-technical-analyzer/4f916770.json"
        },
        "btc": {
            "type": "coin-technical-analyzer",
            "source": "s3",
...
class CoinChartPlotterMockUtility(BaseMockUtility):
    coin_plotter = {
        "sol": {
            ...
            "url": "https://data.pleiades.ai/tool_responses/coin-chart-plotter/4f916770.json"
        },
        "btc": {
            "type": "coin-chart-plotter",
            "source": "s3",
            ...
            "url": "https://data.pleiades.ai/tool_responses/coin-chart-plotter/1413b313.json"
        }
    }
