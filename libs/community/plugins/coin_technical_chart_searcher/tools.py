from pleiadesai_core.plugins.tools.response_dumper_base import S3ResponseDumper
    ...
    examples=[
        {
            ...
            "response": "",
            "image_url": "https://pleiades-ai-assets.s3.eu-central-1.amazonaws.com/example-images/search-coins-by-indicators.png",
        },
        {
