...
from pleiadesai_core.plugins.utilities.adapter_base import BaseAdapter
from pleiadesai_core.plugins.utilities.base import BaseUtility


class BlockchainUtility(BaseUtility):
    request_url: str = Field(
        default="http://pleiades_backend:3000/data/executor",
        exclude=True,
    )
