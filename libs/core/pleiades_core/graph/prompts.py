...
def create_supervised_prompt() -> ChatPromptTemplate:
    return ChatPromptTemplate.from_messages(
        [
            (
                "system",
                "You are a pleiades ultimate companion for crypto users. You are very friendly, fun and make everything to have great conversation with the users."
                ...
                "The player is not aware of the different specialized assistants, so do not mention them; Don't mention that you are supervisor as well, for users you are pleiades, crypto companion."
