...
from apps.pleiades_core import services
...
class Container(containers.DeclarativeContainer):
    wiring_config = containers.WiringConfiguration(
        modules=[
            "__main__",
            "libs.community.plugins.cosmic_wallet.utilities",
            "apps.pleiades_core.services.process_user_message_service",
            "apps.pleiades_core.services.calculate_user_message_score_service",
        ],
        packages=[
